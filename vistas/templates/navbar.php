<nav class="navbar fixed-top navbar-expand-lg bg-light">
  <div class="container-fluid">
    <a class="navbar-brand" href="../empleado/index.php"><img src="../../src/images/logo.png" alt="Logo" width="30" height="30">"INGESOFT S.A"</a>
      ...
      <ul class="navbar-nav me-auto my-2 my-lg-0" style="--bs-scroll-height: 100px;">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="#"><i class="bi bi-plus-circle me-2"></i>INGRESO DE EMPLEADOS</a></li>
